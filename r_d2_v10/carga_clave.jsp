...
%>
<%
String noaf_jv="",nom_jv="",ap_jv="",ap5_jv="",am_jv="",am22_jv="",nombre1_jv="",clave_jv="",clave2_jv="",descrip_jv="",origen_jv="",exist_jv="",origen2="",exist2_jv="0",total22_jv="",clave22_jv="",origen22_jv="",descrip22_jv="",fechanew="";
String but="r";
    ...
    <td width="650"><form id="form" name="form" method="post" action="carga_clave.jsp?usuario=<%=am22_jv%>">
      <table width="650" height="323" border="0" align="center" cellpadding="2">
        <tr>
          ...
          <td height="49" colspan="2" bgcolor="#FFFFFF" class="logo style1"><div align="center">Carga de Clave al Inventario </div></td>
