...
<p>
  <%
	...
	rset__002=stmt__002.executeQuery("select sum(cant_sur) from receta_colectiva");
	 ...
	 rset__001=stmt__001.executeQuery("select clave, descrip, sum(cant_sur) from receta_colectiva where fecha_re between '"+date1_jv+"' and '"+date2_jv+"'  group by clave order by (clave+0)");
	rset__002=stmt__002.executeQuery("select sum(cant_sur) from receta_colectiva where fecha_re between '"+date1_jv+"' and '"+date2_jv+"' ");
 	}
