...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
 ...
 rset__001=stmt__001.executeQuery("select * from t_rep where execu='"+recibe_jv+"'  and date between '"+date1_jv+"' and '"+date2_jv+"' ");
	...
	{
 rset__001=stmt__001.executeQuery("select * from receta_colectiva where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='"+origen_jv+"' and tipo_receta='rc'");
	}
...
<table width="1320" cellpadding="3" cellspacing="1" border="0" >
  ...
  <tr height="20">
    <td height="20" colspan="8"  align="center"><p align="center">GOBIERNO DEL ESTADO DE DURANGO</p>
  ...
  <tr height="20">
    ...
    <td height="20" width="208" style="border:double"><div align="center">Servicio </div></td>
  ...
  <tr height="20" >
    ...
    <td height="20" style="border:double"><%=rset__001.getString("servicio")%></td>
