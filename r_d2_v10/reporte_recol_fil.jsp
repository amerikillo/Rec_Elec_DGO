...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
 ...
 rset__003=stmt__003.executeQuery("select * from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='1' and tipo_receta='rc' ");
 ...
 rset__004=stmt__004.executeQuery("select * from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='2' and tipo_receta='rc' ");
...
<table width="453" border="0" align="center" cellpadding="2">
  <tr>
...
<table width="20%" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
    ...
    <td colspan="2" valign="top"><form action="reporte_recol_fil.jsp" method="post" name="form" onSubmit="javascript:return ValidateAbas(this)">
    <table width="448" border="0" align="center">
      <tr>
        <td width="458"><table width="442" border="1">
            <tr>
              <td width="63"><span class="style49">Fecha</span></td>
              <td width="69"> <span class="style49">Servicio</span>                </td>
              <td width="49"> <span class="style49">Clave </span></td>
              <td width="76"> <span class="style49">Descripci&oacute;n</span></td>
              
         <td width="43"> <span class="style49">Origen</span></td>
              <td width="59"> <span class="style49">Cant. Sol </span></td>
              <td width="67"> <span class="style49">Cant. Sur</span></td>
            </tr>
			<%
			if(ban>0)
			{
			 rset__001=stmt__001.executeQuery("select servicio,clave,descrip,partida,sum(cant_sol),sum(cant_sur),fecha_re,folio_re from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='1' and tipo_receta='rc' group by id order by fecha_re ");
	...
	%>
            <tr>
              <td><span class="style49"><%=date_jv%></span></td>
                 <td><span class="style49"><a href="recibo_farm_fil.jsp?folio=<%=rset__001.getString("folio_re")%>&uni=<%=llamo_cat_jv%>&f1=<%=date11_jv%>&f2=<%=date22_jv%>"><%=rset__001.getString("servicio")%></a></span></td>
			...
			<%}
			rset_1=stmt__001.executeQuery("select sum(cant_sol),sum(cant_sur) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='1' and tipo_receta='rc'");
			while(rset_1.next()) 
                  {
            ...
            <tr>
              ...
              <td> <span class="style49">Clave </span></td>
         ...
         <td> <span class="style49">Origen</span></td>
			...
			rset__002=stmt__002.executeQuery("select servicio,clave,descrip,partida,sum(cant_sol),sum(cant_sur),fecha_re,folio_re from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='2' and tipo_receta='rc' group by id order by fecha_re");
	...
	%>
            <tr>
             ...
             <td><span class="style49"><a href="recibo_col_fil.jsp?folio=<%=rset__002.getString("folio_re")%>&uni=<%=llamo_cat_jv%>&f1=<%=date11_jv%>&f2=<%=date22_jv%>"><%=rset__002.getString("servicio")%></td>
              ...
              <td align="center"><span class="style49"><%=rset__002.getString("sum(cant_sol)")%></span></td>
              <td align="center"><span class="style49"><%=rset__002.getString("sum(cant_sur)")%></span></td>
            </tr>
			<%}
			rset_11=stmt__0011.executeQuery("select sum(cant_sol),sum(cant_sur) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='2' and tipo_receta='rc'");
			while(rset_11.next()) 
                  {
