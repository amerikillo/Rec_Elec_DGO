...
Connection conn1 = DriverManager.getConnection("jdbc:mysql://localhost/r_d");
        ...
        ResultSet rset1=stmt1.executeQuery("select * from uni_atn where uni='"+usu_jv+"' and clave='"+pass_jv+"'");
          while (rset1.next()) 
                  { 
		...
		alert("DATOS CORRECTOS")
		 self.location='recedgo.jsp?uni=<%=usu_jv%>&juris=<%=no_jv%>&nombre=&edad=&folio=&cause=&clave1=&descrip1=&present1=&indica1=&sol1=&sur1=&clave2=&descrip2=&present2=&indica2=&sol2=&sur2=&clave3=&descrip3=&present3=&indica3=&sol3=&sur3=';
		</script>
		<%
		stmt1.execute("insert into pass_rd values (0,'"+pass_jv+"','"+usu_jv+"','"+juris_jv+"','"+date+"','CORRECTO')");
		}else{
		%>
		<script>
		...
		<%
		//out.print(""+juris_jv);
		stmt1.execute("insert into pass_rd values (0,'"+pass_jv+"','"+usu_jv+"','"+juris_jv+"','"+date+"','INCORRECTO')");
		}
