...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date1_jv+"', '%d/%m/%Y')"); 
 ...
 rset__001=stmt__001.executeQuery("select * from t_rep where execu='"+recibe_jv+"'  and date='"+date1_jv+"' ");
	...
	{
 rset__001=stmt__001.executeQuery("select clave,descrip,sum(cant_sur),present from receta where unidad='"+llamo_cat_jv+"' and fecha_re='"+date1_jv+"' and partida='"+origen_jv+"' and tipo_receta='rf' group by clave order by clave asc; ");
	}
...
<table width="1320" cellpadding="3" cellspacing="1" border="0" >
  <tr height="20">
    <td height="20" colspan="10"  align="center"><p align="center">REPORTE  DIARIO RECETA PORFARMACIA </p>
