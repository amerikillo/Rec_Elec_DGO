...
int sol1=0,sur1=0,solx=0,sur11=0,sur111=0,ban=0,ban2=0,solx1=0;
double total=0.0,total2=0.0,total3=0.0,precio2=0.0,precio3=0.0,sur22=0.0,sur_p=0.0;
	  try {
...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
 ...
 rset__003=stmt__003.executeQuery("select clave,descrip,sum(cant_sur) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='1' group by clave order by (clave+0) ");
 ...
 rset__004=stmt__004.executeQuery("select clave,descrip,sum(cant_sur) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='2' group by clave order by (clave+0)");
...
<table width="922" border="0" align="center" cellpadding="2">
  <tr>
    <td width="155"><div align="center"><img src="logo_dgo.jpg" width="96" height="88" />&nbsp;</div></td>
    <td height="63" colspan="2" align="center" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" id="logo"><div align="center">
      <span class="Estilo3">GOBIERNO DEL ESTADO DE DURANGO<br />
    ...
    <td width="195"><div align="center"><img src="soriana.jpg" width="96" height="88" />&nbsp;</div></td>
  </tr>
...
<table width="10%" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
    ...
    <td colspan="2" valign="top"><form action="reporte_global.jsp" method="post" name="form" onSubmit="javascript:return ValidateAbas(this)">
    <table width="800" border="0" align="center">
      <tr>
        <td width="418"><table width="1134" border="1">
            <tr>
              
              <td width="77"> <span class="style50">Clave </span></td>
              <td width="759"> <span class="style50">Descripci&oacute;n</span></td>
               <td width="51"> <span class="style50">Origen</span></td>
              <td width="82"> <span class="style50">Costo Unitario </span></td>
        
             
              <td width="60"> <span class="style50">Cant. Sur</span></td>
              <td width="65"> <span class="style50">Costo Total </span></td>
            </tr>
			<%
			if(ban>0)
			{
			 rset__001=stmt__001.executeQuery("select fecha_re,partida,clave,descrip,sum(cant_sur) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='1' group by clave order by (clave+0) ");
    while(rset__001.next()) 
                  {		
				  clave= rset__001.getString("clave");
				  date_jv=rset__001.getString("fecha_re");
				  sol=rset__001.getString("sum(cant_sur)");
				  sur22= Integer.parseInt(sol);
	...
	%>
            <tr>
              ...
              <td><span class="style50"><%=rset__001.getString("clave")%></span></td>
              <td><span class="style50"><%=rset__001.getString("descrip")%></span></td>
               <td align="center"><span class="style50"><%=rset__001.getString("partida")%></span></td>
              <td align="center"><span class="style50"><%=precio%></span></td>
              
              
              <td align="center"><span class="style50"><%=rset__001.getString("sum(cant_sur)")%></span></td>
              <td align="center"><span class="style50">
                <%//=total%>
              -
              </span></td>
            </tr>
			<%}
			rset_1=stmt__001.executeQuery("select clave,descrip,sum(cant_sur) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='1' group by clave_uni");
			while(rset_1.next()) 
                  {
            ...
            <tr>
              ...
              <td class="style50" align="center">TOTAL</td>
              
              
              <td class="style50" align="center"><%=formateador.format(sur1)%></td>
              <td class="style50" align="center"><%//=sur1%>
-                </td>
            </tr>
            <%}
			...
			%>
              ...
              <tr><td> <span class="style50">Clave Articulo </span></td>
              <td> <span class="style50">Descripci&oacute;n</span></td>
              <td> <span class="style50">Origen</span></td>
              <td> <span class="style50">Costo Unitario </span></td>
         
             
              <td> <span class="style50">Cant. Sur</span></td>
              <td> <span class="style50">Costo Total </span></td>
            </tr>
			<%
			
			
			rset__002=stmt__002.executeQuery("select fecha_re,partida,clave,descrip,sum(cant_sur) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='2' group by clave order by (clave+0) ");
			
    while(rset__002.next()) 
                  {		
				  clave1= rset__002.getString("clave");
				  date1x_jv=rset__002.getString("fecha_re");
				   sol1x=rset__002.getString("sum(cant_sur)");
				  solx1= Integer.parseInt(sol1x);
				  Connection conn = 
                  DriverManager.getConnection("jdbc:mysql://localhost/r_d");
                  Statement stmt_date = conn.createStatement();
				  ResultSet rset_date = stmt_date.executeQuery("SELECT DATE_FORMAT('"+date1x_jv+"', '%d/%m/%Y')"); //;SELECT STR_TO_DATE('"+date_jv+"', '%m/%d/%Y')
                    ...
                    date1_jv= rset_date.getString("DATE_FORMAT('"+date1x_jv+"', '%d/%m/%Y')");
					...
					precio3=Double.parseDouble(precio1);
					}
					
					
					 total2=solx1*precio3;
					 total3+=total2;
	%>
            <tr>
              
              <td><span class="style50"><%=rset__002.getString("clave")%></span></td>
              <td><span class="style50"><%=rset__002.getString("descrip")%></span></td>
              <td align="center"><span class="style50"><%=rset__002.getString("partida")%></span></td>
              <td align="center"><span class="style50"><%=precio1%></span></td>
              
             
              <td align="center"><span class="style50"><%=rset__002.getString("sum(cant_sur)")%></span></td>
              <td align="center"><span class="style50"><%=formateador.format(total2)%></span></td>
            </tr>
			<%}
			rset_11=stmt__0011.executeQuery("select clave,descrip,sum(cant_sur) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='2' group by clave_uni");
			while(rset_11.next()) 
                  {
            ...
            <tr>
              ...
              <td class="style50" align="center"><%=sur111%></td>
              <td class="style50" align="center"><%=formateador.format(total3)%></td>
            </tr>
            <tr>
              <td colspan="6">&nbsp;</td>
              </tr>
            ...
            <tr>
              ...
              <td colspan="6"><span class="Estilo5">ADMINISTRADOR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ENCARGADO(A) TIENDAS SORIANA S.A. DE C.V&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ENCARGADO(A) DE LA SECRETARIA DE SALUD DE DURANGO</span> </td>
              </tr>
            <%}%>
