...
<table width="666" height="346" border="3" align="center" cellpadding="2" bgcolor="#FFFFFF">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a name="Arriba" id="Arriba"></a>&nbsp;Inventario Unidad&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
          <td height="14" colspan="6" bgcolor="#009999"><span class="style2">ii<span class="Estilo8"><span class="Estilo9">Exportar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><img src="icono_excel.gif" border="0" usemap="#Map2"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span><span class="Estilo13"><span class="Estilo14"><a href="#Total">Ir a Totales</a></span></span></td>
          </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="55"><div align="center" class="Estilo10">
			<%=nf1.format(cajas)%>
          </div></td>
          <td width="38"><div align="center"><%=rset_002.getString("cant")%></div></td>
		...
		<td>
		  <p align="right" class="Estilo9"><strong><a name="Total" id="Total"></a>Total</strong></p>		  </td>
