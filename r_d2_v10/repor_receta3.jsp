...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
 ...
 rset__001=stmt__001.executeQuery("select * from t_rep where execu='"+recibe_jv+"'  and date between '"+date1_jv+"' and '"+date2_jv+"' ");
	...
	{
 rset__001=stmt__001.executeQuery("select clave,descrip,sum(cant_sur),present from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='"+origen_jv+"' and tipo_receta='rf' group by clave order by clave asc; ");
	}
...
<table width="1320" cellpadding="3" cellspacing="1" border="0" >
 <tr height="20">
    ...
    <td height="20" colspan="0" align="center" >&nbsp;</td>
  ...
  <tr height="20">
    <td height="20" colspan="11"  align="center"><p align="center">GOBIERNO DEL ESTADO DE DURANGO</p>
      ...
      <p align="center">REPORTE  DE CONSUMO POR RECETA FARMACIA </p>
