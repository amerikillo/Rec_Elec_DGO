...
Connection connPaso = DriverManager.getConnection("jdbc:mysql://localhost/r_d");

 		Statement stmt_paso = connPaso.createStatement();
...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
	...
	{
 rset__001=stmt__001.executeQuery("select clave,descrip,sum(cant_sol),sum(cant_sur) ,ampuleo from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='"+org_jv+"'  and tipo_receta='rf' group by clave order by (clave+0)");
 ...
 <tr>
      ...
      <tr>
        <td width="418"><table width="1000" border="1">
            <tr>
              ...
              <td width="85"> <span class="Estilo13">Clave Articulo </span></td>
              <td width="433"> <div align="center"><span class="Estilo13">Descripci&oacute;n</span></div></td>
              
              
              <td width="62"><span class="Estilo13">Costo U. </span></td>
              <td width="83"> <span class="Estilo13">Cant. Sur</span></td>
			  <td width="75"> <span class="Estilo13">Ampula</span></td>
			   <td width="102"> <span class="Estilo13">Presentaci&oacute;n</span></td>
			   <td width="90"> <span class="Estilo13">Cajas ampuleo</span></td>
				  ...
				  ampula ="-";
					...
					if (rset__001.getString("ampuleo").equals("1")){
						if (rset_paso.next()){
								...
								cantidadCajas =  sur11 /Integer.parseInt( presentacion) ;
								...
								piezasPorAmpula = sur11+ piezasPorAmpula;
	...
	%>
            <tr>
			  ...
			  <%}else{%>
				  <td align="center" class="Estilo9"><%=presentaInfo%>&nbsp;</td>
			  <%}%>
			  <td class="Estilo6" align="center"><%=ampula%>&nbsp;</td>
			  
			  <td align="center"><span class="Estilo9"><%=presentacion%></span></td>
			
			  
				  <td width="18" align="center"><span class="Estilo9"><%=presentaInfo%></span></td>
            ...
            <tr>
              ...
              <td align="center" class="Estilo9"><%=(sur1- piezasPorAmpula) + totalCajasAmpuleo%>&nbsp;</td>
			  	    <td width="75"> <span class="Estilo13"></span></td>
            ...
            <tr>
              ...
              <td colspan="4" style="font-size:10px">ADMINISTRADOR&nbsp;DE LA UNIDAD &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ENCARGADO(A) DE LA FARMACIA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; FILTRO  SECRETARIA DE SALUD DE DURANGO</div></td>
              </tr>
