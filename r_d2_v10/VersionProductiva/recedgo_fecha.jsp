...
if(but.equals("Clave"))
     {
	  ...
	  folio_jv=request.getParameter("txtf_foliosp");
		...
		%>	
		  		...
		  		<script>
		 			 alert('Clave se dispensara por caja');
		  		</script>	  
		 <%	  
...
if(but.equals("Imprimir"))
     {
	  ...
	  %>
	  <script>
	  self.location='recibo_farm_fecha.jsp?folio=<%=foliore2_jv%>&receta5=RF&encar=<%=encar_jv%>&uni=<%=nom_unidad%>&juris=<%=no_jur%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&part=<%=part_jv%>&id_med=<%=id_med_jv%>';
...
<form name="form" method="post" action="recedgo_fecha.jsp?uni=<%=nom_unidad%>&juris=<%=no_jur%>&nombre=<%=nombre_jv%>&edad=<%=edad_jv%>&folio=<%=folio_jv%>&clave1=<%=clave1_jv%>&descrip1=<%=descrip1_jv%>&present1=<%=present1_jv%>&indica1=<%=indica1_jv%>&sol1=<%=sol1_jv%>&sur1=<%=sur1_jv%>&cause=<%=cause_jv%>&foliore=<%=foliore_jv%>&encar=<%=encar_jv%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&univer=<%=uni_jv%>&cedu=<%=cedu_jv%>&nomed=<%=nomed_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&day5=<%=t1_jv%>&mes5=<%=t2_jv%>&aa5=<%=t3_jv%>&programa=<%=programa_jv%>">
<a href="index.jsp" class="style2">REGRESAR A MENÚ</a>
<table width="878" height="644" border="3" align="center" cellpadding="2">
  <tr>
    <td width="725" height="114"><table width="837" border="0" align="center" cellpadding="2">
      <tr>
        ...
        <tr>
          <td height="219" colspan="3" class="style4"><table width="839" border="0" align="center" cellpadding="2">
            ...
            <tr>
              ...
              <input type="text" name="txtf_med1" id="txtf_med1" size="10" value="<%=med1_jv%>"  onkeypress="return handleEnter(this, event)"/><input name="Submit" type="submit" class="subHeader" value="Clave" />&nbsp;<a href="index_carga_clave.jsp" target="_blank">Agregar Clave al Inventario</a></td>
            ...
            <tr>
              ...
              <td width="64" class="style11"><span class="style2">CAUSES</span></td>
            ...
            <tr>
              ...
              <td class="style11">&nbsp;
              <input name="Submit" type="submit" class="but" value="Capturar" onClick="return verificaN_Fa(document.forms.form)" onChange="setSur(this.form)"/>              </td>
            </tr>
            <tr>
              <td class="style11">&nbsp;</td>
            ...
            <tr>
              ...
              <td width="64" align="center" class="style11"><span class="style2">CANT. SUR </span></td>
              <td width="102" align="center" class="style11"><span class="style2">SE SURTI&Oacute;</span></td>
  ...
  %>
	  ...
	  %>
            ...
            <tr>
              ...
              <td class="style11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <label id="ampuID" style="visibility:hidden; font:bold;  background:red" for="Ampuleo">Clave ampuleo dispensar pieza</label></td>
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
