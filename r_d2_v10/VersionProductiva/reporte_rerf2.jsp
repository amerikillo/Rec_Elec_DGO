...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
	...
	{
 rset__001=stmt__001.executeQuery("select fecha_re,folio_re,nombre_medi,nombre_pac,clave,descrip,cant_sol,cant_sur from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='"+org_jv+"' and tipo_receta='rf' order by (fecha_re),folio_re asc");
	}
...
rset_2=stmt__002.executeQuery("select count(folio_re) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='"+org_jv+"' and tipo_receta='rf' group by folio_re");
            ...
            <tr>
              <td colspan="5" class="style49" align="center">TOTAL RECETAS EMITIDAS= <%=folio_re2%></td>
