...
// Rutina para fechas
		 ...
		 if( (month>=1 && (years>=115 || years<=109))  || (month2>=11 && (years2>=115 || years<=109)) )
		     {bancom=3;}
...

{
					...
					if((reporte_jv.equals("rc")) && (!(org_jv.equals("ambos"))))
					{
					%>
					<script>
...
<title>Reportes por Colectiva</title>
                ...
                <tr>
                  ...
                  <td width="453"><div align="center">
                      <table width="555" border="0" align="center" cellpadding="2" cellspacing="3">
                        <form action="reportes_colectiva.jsp" method="post" >
                          <tr>
                          ...
                          <tr>
                            <td colspan="14" class="style1" >Tipo de Reporte: 
                             ...
                             <input name="reporte" type="radio" value="rc" checked="checked"/>
                            RECETA COLECTIVA </td>
                            <td colspan="2" >&nbsp;</td>
                          </tr>
                          <tr>
