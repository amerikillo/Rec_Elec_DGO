...
if(but.equals("Imprimir"))
     {
	  ...
	  %>
	  <script>
	  self.location='recibo_reem.jsp?folio=<%=foliore2_jv%>&receta5=RF&encar=<%=encar_jv%>&uni=<%=nom_unidad%>&juris=<%=no_jur%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&part=<%=part_jv%>&id_med=<%=id_med_jv%>';
...
<title>.:Reimprimir Ticket Electr&oacute;nica WEB:.</title>
...
<form name="form" method="post" action="reempresion.jsp?uni=<%=nom_unidad%>&juris=<%=no_jur%>&nombre=<%=nombre_jv%>&edad=<%=edad_jv%>&folio=<%=folio_jv%>&clave1=<%=clave1_jv%>&descrip1=<%=descrip1_jv%>&present1=<%=present1_jv%>&indica1=<%=indica1_jv%>&sol1=<%=sol1_jv%>&sur1=<%=sur1_jv%>&cause=<%=cause_jv%>&foliore=<%=foliore_jv%>&encar=<%=encar_jv%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&univer=<%=uni_jv%>&cedu=<%=cedu_jv%>&nomed=<%=nomed_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&day5=<%=t1_jv%>&mes5=<%=t2_jv%>&aa5=<%=t3_jv%>&part=<%=part_jv%>&carnet=<%=carnet_jv%>">
<a href="index.jsp" class="style2">REGRESAR A MENÚ</a>
<table width="779" height="621" border="3" align="center" cellpadding="2">
  <tr>
    <td width="725" height="114"><table width="758" border="0" align="center" cellpadding="2">
      <tr>
        ...
        <td width="225"><img src="logo_dgo.jpg" width="126" height="76" /><!--input name="Submit"  type="reset" class="bodyText" value="Borrar Datos" /--></td>
      </tr>
    </table>
      <table width="763" height="45" border="0" align="center" cellpadding="2">
        <tr>
          <td width="342" height="41">
            <table width="343" height="0%" border="0" cellpadding="2">
              <tr>
                <td width="221" height="100%" class="style2">Ingrese No. Folio:<input name="txtf_foliore" type="text" class="style13"  value="<%=foliore_jv%>" size="20" onKeyPress="return handleEnter(this, event)"/>&nbsp;<input name="Submit" type="submit" class="subHeader" value="Por Folio"/></td>
              </tr>
            </table>          </td>
          <td width="219"><table width="167" height="0%" border="0" cellpadding="2">
            <tr>
          ...
          <td width="182" align="center" class="style2">
            FECHA:
                  <input name="txtf_t1" type="text" onKeyPress="return handleEnter(this, event)" onKeyUp="putDays()" value="<%=t1_jv%>" size="10"/>
        ...
        <tr>
          <td height="219" colspan="3" class="style4"><table width="763" border="0" align="center" cellpadding="2">
            ...
            <tr>
              ...
              <input type="text" name="txtf_med1" size="10" value="<%=med1_jv%>"  onkeypress="return handleEnter(this, event)"/></td>
            ...
            <tr>
              ...
              <td class="style11"><input name="radiosur" type="radio" value="SI" checked="checked" onKeyPress="return handleEnter(this, event)" />
                ...
                NO</td>
              <td class="style11"><span class="style2"></td>
            </tr>
            <tr>
              <td class="style11">&nbsp;</td>
  ...
  %>
	  ...
	  %>
            ...
            <tr>
              ...
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
              <td class="style11"><input name="Submit" type="submit" class="subHeader" value="Imprimir" />
              &nbsp;<span class="style2">Cerrar </span> <button name="boton" type="button" class="style7" onClick="CloseWin()" /><img src="borr.jpg" /></button></td>
            </tr>
          </table></td>
  </tr>
        </tr>
