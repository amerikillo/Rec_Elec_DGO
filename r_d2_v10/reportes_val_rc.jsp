...
// Rutina para fechas
		 ...
		 if( (month>=1 && (years>=115 || years<=108))  || (month2>=11 && (years2>=115|| years<=108)) )
		     {bancom=30;}
  ...
  <tr bgcolor="#D5EDB3">
    ...
    <td height="50" colspan="3" align="center" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" id="logo"><div align="right">
      <table width="946" border="0" align="left" cellpadding="2">
        <tr>
          <td width="870" rowspan="2"><div align="center" class="style5 style6">SISTEMA REPORTEADOR DE VALIDACIONES POR MES RECETA COLECTIVA </div></td>
                  ...
                  <td width="638"><div align="center">
                      <table width="687" border="0" align="center" cellpadding="2" cellspacing="3">
                        <form action="reportes_val_rc.jsp" method="post" >
                          ...
                          <tr>
                            <td colspan="14" class="style1"><div align="left"><a href="index_reporte_val.jsp">Regresar a Menú</a></div></td>
                          </tr>
                          <tr>
