...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date1_jv+"', '%d/%m/%Y')"); 
	...
	{
 rset__001=stmt__001.executeQuery("select clave_uni,clave,descrip,sum(cant_sol),sum(cant_sur),present from receta_colectiva where unidad='"+llamo_cat_jv+"' and fecha_re='"+date1_jv+"' and partida='"+org_jv+"'  and tipo_receta='rc' group by clave order by (clave+0)");
...
<table width="1048" border="0" align="center" cellpadding="2">
  <tr>
    ...
    <td height="63" colspan="2" align="center" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" id="logo"><div align="center">
      <span class="Estilo14">REPORTE DIARIO RECETA COLECTIVA<br />
    DE LA UNIDAD: <%=llamo_cat_jv%><br />
    PERIODO: <%=date1_jv%></span><br />
    <br />
    </div></td>
...
<table width="20%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="#CCFF99">
      ...
      <a href="reportes_diario_rc.jsp" class="style76"><span class="Estilo1">Regresar a Menú</span></a></span>&nbsp;
      <!--img src="icono_excel.gif" border="0" usemap="#Map2"/-->&nbsp;&nbsp;&nbsp;<span class="Estilo1">&nbsp;&nbsp;EXPORTAR&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="icono_excel.gif" border="0" usemap="#Map2"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Estilo1">ORIGEN&nbsp;"<%=dest%>"</span></td>
  </tr>
 <tr>
    <td colspan="7" bgcolor="#003366"><img src="mm_spacer.gif" alt="" width="1" height="1" border="0" /></td>
  </tr>
 ...
 <tr>
    ...
    <td colspan="2" valign="top"><form action="global_diario_rc.jsp" method="post" name="form" onSubmit="javascript:return ValidateAbas(this)">
	...
	%>
			...
			rset_1=stmt__001.executeQuery("select sum(cant_sol),sum(cant_sur) from receta_colectiva where unidad='"+llamo_cat_jv+"' and fecha_re='"+date1_jv+"' and partida='"+org_jv+"' and tipo_receta='rc'");
			while(rset_1.next()) 
                  {
           ...
           <%
			//**************conexion a servidor
			rset05= stmt05.executeQuery("select * from consolidado where clave_unidad='"+clave_unidad+"' and fecha='"+date1_jv+"' and tipo_receta='RC' group by clave_unidad,fecha");
					while(rset05.next())
						{
							    cont1++;
						}
							  ...
							  <%
							   ...
							   %>
									<script>
										...
										alert("ESTA INFORMACION no se ha enviado...!!!");
									
									</script>
							  <%
							    rset06=stmt06.executeQuery("select clave,descrip,sum(cant_sol),sum(cant_sur),present from receta_colectiva where unidad='"+llamo_cat_jv+"' and fecha_re='"+date1_jv+"'and partida='"+org_jv+"'  and tipo_receta='RC' group by clave order by (clave+0)");
							    while (rset06.next()){
								...
								//*******************************SE INSERTA LA INFORMACION EN LA TABLA CONSOLIDADO DEL SERVER*******************************************************
									...
									stmt05.execute("insert into consolidado values ('"+clave_unidad+"','"+clave_medicamento+"','"+descripcion+"','"+presentacion+"','"+cantidad+"','"+present+"','"+total3+"','"+resto+"','"+date1_jv+"','RC')");	
								}
							   }
...
<map name="Map2" id="Map2">
  <area shape="rect" coords="6,5,33,31" href="excel_rc.jsp?f1=<%=date11_jv%>&boton=Show ALL&unidad=<%=llamo_cat_jv%>&org=<%=org_jv%>" />
</map>
</body>
</html>
