...

{
				...
				self.location='global_diario_rf.jsp?reporte=<%=reporte_jv%>&unidad=<%=unidad_jv%>&f1=<%=fecha_1_jv%>&org=<%=org_jv%>&boton=Show ALL&boton2=Show ALL2';
					...
					%>
					<script>
				self.location='global_diario_rc.jsp?reporte=<%=reporte_jv%>&unidad=<%=unidad_jv%>&f1=<%=fecha_1_jv%>&org=<%=org_jv%>&boton=Show ALL';
					</script>
					<%
					 }else if((reporte_jv.equals("global2")) && ((org_jv.equals("ambos"))))
					{
					%>
					<script>
				self.location='global_diario_rc.jsp?reporte=<%=reporte_jv%>&unidad=<%=unidad_jv%>&f1=<%=fecha_1_jv%>&org=<%=org_jv%>&boton=Show ALL&boton2=Show ALL2';
					</script>
					<%
					 }
  ...
  <tr bgcolor="#D5EDB3">
    ...
    <td height="50" colspan="3" align="center" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" id="logo"><div align="right">
      <table width="946" border="0" align="left" cellpadding="2">
        <tr>
          <td width="870" rowspan="2"><div align="center" class="style5 style6">SISTEMA REPORTEADOR DE VENTA DIARIA POR RECETA COLECTIVA</div></td>
                ...
                <tr>
                  ...
                  <td width="638"><div align="center">
                      <table width="687" border="0" align="center" cellpadding="2" cellspacing="3">
                        <form action="reportes_diario_rc.jsp" method="post" >
                          <tr>
                          ...
                          <tr>
                            <td colspan="14" class="style1"><div align="left"><a href="index_diario.jsp">Regresar a Menú</a></div></td>
                          </tr>
                          <tr>
                            <td colspan="14" class="style1"><div align="center"></div></td>
                          </tr>
                          <tr>
                            <td colspan="16" class="style1" ><div align="center">
                              <input name="reporte" type="radio" value="global2"  checked="checked"/>
                            Reporte Diario de Ventas RC                            </div></td>
                          </tr>
                          <tr>
		...
		%>
           ...
           %>
					...
					%> 
                          ...
                          <tr>
                            <td bgcolor="#FFFFFF" colspan="15" class="style1" align="center">&nbsp;
                                                         <label>
          ...
          <label></label>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td width="22" class="style1 style2">&nbsp;</td>
                            <td colspan="7" class="style1 style2">&nbsp;</td>
                            <td width="22" class="style1 style2">&nbsp;</td>
