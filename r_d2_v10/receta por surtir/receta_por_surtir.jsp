        ...
        <tr>
          <td height="219" colspan="3" class="style4"><table width="763" border="0" align="center" cellpadding="2">
            ...
            <tr>
              ...
              <input type="text" name="txtf_med1" size="10" value="<%=med1_jv%>"  onkeypress="return handleEnter(this, event)"/><input name="Submit" type="submit" class="subHeader" value="Clave" /></td>
            ...
            <tr>
              ...
              <td class="style11"><input name="radiosur" type="radio" value="SI" checked="checked" onKeyPress="return handleEnter(this, event)" />
                ...
                NO</td>
              <td class="style11"><span class="style2"><input name="Submit" type="submit" class="but" value="Capturar" onClick="return verificaN(document.forms.form)" onChange="setSur(this.form)"/>
              </td>
            </tr>
            <tr>
              <td class="style11">&nbsp;</td>
