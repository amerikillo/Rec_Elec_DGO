...

{
					...
					if((reporte_jv.equals("receta")) && (!(org_jv.equals("-OR-"))))
					{
					%>
					<script>
				self.location='reporte_re.jsp?reporte=<%=reporte_jv%>&unidad=<%=unidad_jv%>&f1=<%=fecha_1_jv%>&f2=<%=fecha_2_jv%>&org=<%=org_jv%>&boton=Show ALL';
					...
					<%
					}else if((reporte_jv.equals("global")) && (!(org_jv.equals("-OR-"))))
					{
					%>
					<script>
                  ...
                  <td width="453"><div align="center">
                      <table width="555" border="0" align="center" cellpadding="2" cellspacing="3">
                        <form action="reportes.jsp" method="post" >
                          ...
                          <tr>
                            <td colspan="4" class="style1" >Tipo de Reporte: </td>
                            <td width="57" ><label>
                              <div align="right">
                                <input name="reporte" type="radio" value="global" />
                                </div>
                            </label></td>
                            <td width="57"  class="style1">Global</td>
                            <td width="57" ><div align="right">
                              <input name="reporte" type="radio" value="receta" checked="checked"/>
                            </div></td>
                            <td colspan="3"  class="style1">Por Receta </td>
                            <td width="57" ><div align="right"><a onclick="showHideItems('item3',1);">
                              <input name="reporte" type="radio" value="layout" />
                            </a></div></td>
                            <td class="style1">Layout</td>
                            <td colspan="2" >&nbsp;</td>
                          </tr>
                          <tr>
                            <td colspan="2" align="right"><span class="style1"><span class="style2">Usuari</span>o</span>:</td>
