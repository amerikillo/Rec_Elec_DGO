...

{
				...
				self.location='reporte_re.jsp?reporte=<%=reporte_jv%>&unidad=<%=unidad_jv%>&f1=<%=fecha_1_jv%>&f2=<%=fecha_2_jv%>&org=<%=org_jv%>&boton=Show ALL';
					...
					%>
					<script>
				self.location='reporte_rerf_fil.jsp?reporte=<%=reporte_jv%>&unidad=<%=unidad_jv%>&f1=<%=fecha_1_jv%>&f2=<%=fecha_2_jv%>&org=<%=org_jv%>&boton=Show ALL&boton2=Show ALL2';
					</script>
					...
					%>
					<script>
				self.location='reporte_rerf2_fil.jsp?reporte=<%=reporte_jv%>&unidad=<%=unidad_jv%>&f1=<%=fecha_1_jv%>&f2=<%=fecha_2_jv%>&org=<%=org_jv%>&boton=Show ALL';
					</script>
					...
					%>
					<script>
				self.location='reporte_recol_fil.jsp?reporte=<%=reporte_jv%>&unidad=<%=unidad_jv%>&f1=<%=fecha_1_jv%>&f2=<%=fecha_2_jv%>&org=<%=org_jv%>&boton=Show ALL&boton2=Show ALL2';
					</script>
					...
					%>
					<script>
				self.location='reporte_recol2_fil.jsp?reporte=<%=reporte_jv%>&unidad=<%=unidad_jv%>&f1=<%=fecha_1_jv%>&f2=<%=fecha_2_jv%>&org=<%=org_jv%>&boton=Show ALL';
					</script>
  ...
  <tr bgcolor="#D5EDB3">
    ...
    <td height="50" colspan="3" align="center" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" id="logo"><div align="right">
      <table width="721" border="0" align="left" cellpadding="2">
        <tr>
          <td height="23"><div align="center" class="style5 style6">SISTEMA REPORTEADOR  </div></td>
          </tr>
      </table>
    </div></td>
            ...
            <td width="453" class="bodyText"><table width="652" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="37" colspan="4" bgcolor="#FFFFFF"><div align="center">
                      <p><strong><img src="logo_soriana2.jpg" width="191" height="55" /></strong></p>
                  </div></td>
                </tr>
                <tr>
                  ...
                  <td width="453"><div align="center">
                      <table width="555" border="0" align="center" cellpadding="2" cellspacing="3">
                        <form action="reportes_filtro.jsp" method="post" >
                          <tr>
