...
financiamiento[0]="";
origen[0]="";
int pos=0,cont3=0,ban=0,posf=0,ban2=0,cant2_jv=0,cv_med2=0,cv_med3=0,cont1=0,cont5=0,cont6=0,sur2=0,sol2=0,mtotal=0,total2=0,total=0,flag=0,customerIds=0,cant_pasti_ampu=0,cant_surpas_amp=0,ttcant_surpas_amp=0,ttcant_surpas_amp2=0;
String encontrado="",cant_jv="",financiamiento1="",cv_finan_jv="",layout="",status="",cant_pasti="",cant_surpas="",count_cv="",servicio_jv="",fechanew="";
...
if(but.equals("Modificar Servicio"))
     {
	 foliore_jv=request.getParameter("txtf_foliore");
	 servi_jv=request.getParameter("select_servi");
	 foliore4_jv=request.getParameter("select_servi");
	 ...
	 rset1= stmt.executeQuery("select * from receta_colectiva where folio_re='"+foliore_jv+"' ");
	  ...
	  while(rset1.next())
					...
					//out.print(""+cont2);
					 ...
					 stmt.execute("update receta_colectiva set servicio='"+foliore4_jv+"' where folio_re='"+foliore_jv+"' ");
					 //out.print(""+foliore4_jv);
	  ...
	  while(rset1.next())
					 ...
					 stmt.execute("update receta set servicio='"+foliore4_jv+"' where folio_re='"+foliore_jv+"' ");
					 }
					 }
					foliore_jv="";
					servicio_jv=""; 
...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+t3_jv+"', '%d/%m/%Y')"); 
                    while(rset_001.next()){
                    t3_jv= rset_001.getString("STR_TO_DATE('"+t3_jv+"', '%d/%m/%Y')");
					}


//update inventario set cant='"+mtotal2+"' where clave='"+clavesur+"' and origen='"+partidasur+"'");
 stmt.execute("update receta_colectiva set fecha_re='"+t3_jv+"' where folio_re='"+foliore_jv+"' ");
 
	  if(cont>0)
	  {
	  stmt.execute("update receta set fecha_re='"+t3_jv+"' where folio_re='"+foliore_jv+"' ");
	  }
...
if(but.equals("Clave"))
     {
	  ...
	  tfecha_jv=request.getParameter("txtf_t3");
...
fechanew=request.getParameter("txtf_date1");
   ...
   if(cant_surpas_amp==cant_pasti_ampu)
	   ...
	   */
	   ...
	   stmt.execute("insert into receta_colectiva values ('"+foliore_jv+"','"+tfecha_jv+"','"+reloj_jv+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','-','-','-','-','-','-','-','-','"+clave1_jv+"','"+descrip1_jv+"','"+sol1_jv+"','"+sur1_jv+"','SI','"+ela_jv+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','"+part_jv+"','"+present1_jv+"','"+resto_jv+"','"+status+"','RC','-','-','-','-','-','"+servicio_jv+"','"+fechanew+"','M','-','-','-','-','-','-','-','-','-',0)");
	 //  }
	   ...
	   stmt1.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_jv+"','"+part_jv+"','-"+sur1_jv+"','"+mtotal+"','"+fechanew+"','"+ela2_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','-','-','-',0)");	   
 ...
 if (!(sur2>mtotalot))
	...
	stmt.execute("insert into receta_colectiva values ('"+foliore_jv+"','"+tfecha_jv+"','"+reloj_jv+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','-','-','-','-','-','-','-','-','"+clave1_jv+"','"+descrip1_jv+"','"+cant2_o1_jv+"','"+cant2_o1_jv+"','SI','"+ela_jv+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','"+partida_o1_jv+"','"+present1_jv+"','0','SURTIDO COMPLETO','RC','-','-','-','-','-','"+servicio_jv+"','"+fechanew+"','M','-','-','-','-','-','-','-','-','-',0)");				
					
					stmt1og1.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant2_o1_jv+"','"+partida_o1_jv+"','-"+cant2_o1_jv+"','0','"+fechanew+"','"+ela_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','-','-','-',0)");	
	  ...
	  stmt1.execute("update inventario set cant='"+mtotalotsur2+"' where clave='"+clave1_jv+"' and origen='"+partida_o2_jv+"'");
	   ...
	   stmt1og2.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant2_o2_jv+"','"+partida_o2_jv+"','-"+mtotalotsur+"','"+mtotalotsur2+"','"+fechanew+"','"+ela_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','-','-','-',0)");	
...
if(but.equals("Imprimir"))
     {
	  ...
	  %>
	  <script>
	  self.location='recibo_col_sur.jsp?folio=<%=foliore2_jv%>&folio2=<%=customerIds%>&receta5=RC&encar=<%=ela2_jv%>&uni=<%=nom_unidad%>&juris=<%=no_jur%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>';
  ...
  <tr>
    <td width="725" height="156"><table width="710" border="0" align="center" cellpadding="2">
      <tr>
        ...
        <td width="225"><img src="logo_dgo.jpg" width="126" height="76" /></td>
      </tr>
    </table>
      <a href="index.jsp">Regresar a Menu</a>
      <table width="912" height="61" border="0" align="center" cellpadding="2">
        <tr>
          <td width="388" height="55"><label></label>
            <table width="349" height="0%" border="0" cellpadding="2">
              <tr>
                <td width="341" height="100%" class="style2">INGRESE FOLIO:
                  
                  <input type="text" name="txtf_foliore" size="15" class="Estilo5"  value="<%=foliore_jv%>" />&nbsp;<input name="Submit" type="submit" class="subHeader" value="Por Folio"/>              </tr>
            </table>
          <label>          </label></td>
          <td width="216"><table width="205" height="0%" border="0" cellpadding="2">
            <tr>
            ...
            <label></label></td>
          <td width="276" align="center" class="style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FECHA
            <table width="230" height="0%" border="0" align="right" cellpadding="2">
            <tr>
              <td width="222" height="100%"><label>
                <input type='text' name='txtf_t3' id='txtf_t3' title='DD/MM/AAAA' value="<%=t3_jv%>" size='10' maxlength='10' onclick='scwShow(this, event);' readonly="true" class="style1"/>
        </label><img src="calendar.jpg" width="27" height="26" border="0" onClick="scwShow(scwID('txtf_t3'),event);"/> &nbsp;</label><input name="Submit" type="submit" class="subHeader" value="Fecha"  /></td>
            </tr>
          </table></td>
        </tr>
    </table>    </td>
          ...
          <td height="71" colspan="3" class="style4"><table width="784" border="0" align="center" cellpadding="2">
            ...
            <tr>
              <td colspan="2"><textarea name="txtf_unidadmed" cols="40" class="Estilo5" colspan="3" readonly="readonly"><%=nom_unidad%></textarea>
                ...
                <textarea name="txtf_ela" cols="25"  class="Estilo5" readonly="readonly"><%=ela2_jv%></textarea>
              </label></td>
            </tr>
          </table>
		...
		<table width="939" border="0" align="center" cellpadding="2">
            ...
            <tr>
              <td colspan="3" class="style2">&nbsp;Servicio: 
              <input type="text" name="txtf_servicio" class="style2" size="30" value="<%=servicio_jv%>" />&nbsp;&nbsp;<a onClick="showHideItems('item8',1);">Modificar Servicio</a></td>
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
            </tr>
            <tr>
              <td colspan="6" class="style2" id="item8" style="display:none">Ingrese Servicio:
                <select name="select_servi"  class="style2"  onKeyPress="return document.form.txtf_med1.focus();">
...
<option value="YESOS Y CURACIONES">YESOS Y CURACIONES</option>
                ...
                </select>&nbsp;<input name="Submit" type="submit" class="subHeader" value="Modificar Servicio" /></td>
            </tr>
            <tr>
              ...
              <td width="40" class="style11">&nbsp;</td>
              <td width="253" class="style11"><input type="text" name="txtf_resul" size="20" value="<%=formateador.format(ttcant_surpas_amp2)%>" style="visibility:hidden"/></td>
            </tr>
            <tr>
              <td width="93" class="style11"><label> <br />
              </label></td>
              <td width="370" class="style11"><label></label></td>
              <td colspan="2" class="style11"><label><span class="style2">TOTAL EXISTENCIA:<span class="Estilo7"> <%=sumatotal%>&nbsp;</span></label></td>
              <td colspan="2" class="style11"><input type="text" name="txtf_idmed" size="1" value="<%=id_med_jv%>" style="visibility:hidden" />
            ...
            <tr>
              <td width="93" class="style11"><span class="style2">CLAVE </span></td>
              <td class="style11" align="center"><span class="style2">DESCRIPCI&Oacute;N</span></td>
              <td width="71" align="center" class="style11"><span class="style2">CANT. SOL</span></td>
            ...
            <tr>
              ...
              <td class="style11" align="center"><input type="text" class="style2" name="txtf_sur1" size="5" value="<%=sur1_jv%>" onChange="setSur(this.form)" onKeyPress="return validar(event)"/></td>
              <td class="style11" align="center">&nbsp;</td>
  ...
  %>
	  ...
	  %>
              <td class="style11"><input  type="button" id="btn_<%=eliminar_jv%>" name="btn_<%=eliminar_jv%>" class="subHeader" value="Eliminar" onclick='location.href="eliminar_col_sur.jsp?id_prov=<%=eliminar_jv%>&foliore=<%=foliore_jv%>&encar=<%=ela2_jv%>&juris=<%=no_jur%>&uni=<%=nom_unidad%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&day5=<%=t1_jv%>&mes5=<%=t2_jv%>&aa5=<%=t3_jv%>&servicio=<%=servicio_jv%>"'/>&nbsp;<input  type="button" id="btn_<%=eliminar_jv%>2" name="btn_<%=eliminar_jv%>2" class="subHeader" value="Modificar" onclick='location.href="modificar_new_col_sur.jsp?id_prov=<%=eliminar_jv%>&foliore=<%=foliore_jv%>&encar=<%=ela2_jv%>&juris=<%=no_jur%>&uni=<%=nom_unidad%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&day5=<%=t1_jv%>&mes5=<%=t2_jv%>&aa5=<%=t3_jv%>&servicio=<%=servicio_jv%>"'/></td>
            </tr>
			<%
			}
			%>
