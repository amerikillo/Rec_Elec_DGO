...
<table width="20%" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
    ...
    <td colspan="2" valign="top"><form action="reporte_recol.jsp" method="post" name="form" onSubmit="javascript:return ValidateAbas(this)">
      ...
      <tr>
        <td width="458"><table width="442" border="1">
         ...
         <td width="43"> <span class="style49">Origen</span></td>
			...
			if(ban>0)
			{
			 rset__001=stmt__001.executeQuery("select servicio,clave,descrip,partida,sum(cant_sol),sum(cant_sur),fecha_re from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='1' and tipo_receta='rc' group by id order by fecha_re ");
	...
	%>
         ...
         <td> <span class="style49">Origen</span></td>
			...
			rset__002=stmt__002.executeQuery("select servicio,clave,descrip,partida,sum(cant_sol),sum(cant_sur),fecha_re from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='2' and tipo_receta='rc' group by id order by fecha_re");
	...
	%>
            <tr>
             ...
             <td><span class="style49"><%=rset__002.getString("servicio")%></span></td>
