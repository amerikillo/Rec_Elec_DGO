...
<table width="10%" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
    ...
    <td colspan="2" valign="top"><form action="reporte_rerf.jsp" method="post" name="form" onSubmit="javascript:return ValidateAbas(this)">
	...
	%>
			...
			<%}
			rset_1=stmt__001.executeQuery("select sum(cant_sol),sum(cant_sur) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and tipo_receta='rf'");
			while(rset_1.next()) 
                  {
	...
	%>
            <tr>
              ...
              <td><span class="style49"><%=rset__002.getString("folio_re")%></span></td>
			...
			<%}
			rset_11=stmt__0011.executeQuery("select sum(cant_sol),sum(cant_sur) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and tipo_receta='rf'");
			while(rset_11.next()) 
                  {
