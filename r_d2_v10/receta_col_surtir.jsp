...
encarser_jv=request.getParameter("txtf_encarser");
   ...
   if(cant_surpas_amp==cant_pasti_ampu)
	   ...
	   */
	   ...
	   stmt.execute("insert into receta_colectiva values ('"+foliore_jv+"','"+tfecha_jv+"','"+reloj_jv+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','-','-','-','-','-','-','-','-','"+clave1_jv+"','"+descrip1_jv+"','"+sol1_jv+"','"+sur1_jv+"','SI','"+ela_jv+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','"+part_jv+"','"+present1_jv+"','"+resto_jv+"','"+status+"','RC','-','-','-','-','-','"+servicio_jv+"','"+fechanew+"','M','"+encarser_jv+"','-','-','-','-','-','-','-','-',0)");
	 //  }
 ...
 if (!(sur2>mtotalot))
	  ...
	  resto_jv=sol2-sur2;
	   ...
	   //--------------------------------Origen 3------------------------------------------------------------------------
		  ...
		  stmt.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_03+"','"+partida_o3_jv+"','"+(-cant2_o3_jv)+"','"+(cant_03-cant2_o3_jv)+"','"+fechanew+"','"+ela_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','-','-','-',0)");
		  }
	   }
	   if (mtotalotsur>0){
		if (cant2_o2_jv>0){
...
if(but.equals("Imprimir"))
     {
	  ...
	  %>
	  <script>
	  self.location='recibo_col_sur.jsp?folio=<%=foliore2_jv%>&folio2=<%=customerIds%>&receta5=RC&encar=<%=ela2_jv%>&uni=<%=nom_unidad%>&juris=<%=no_jur%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&encarser=<%=encarser_jv%>';
...
<option value="YESOS Y CURACIONES">YESOS Y CURACIONES</option>
            ...
            <tr>
              <td colspan="3" class="style2">Encargado del Servicio: <input type="text" name="txtf_encarser" class="style2" size="60" value="<%=encarser_jv%>" readonly="true"/></td>
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
              <td class="style11">&nbsp;</td>
            </tr>
            ...
            <tr>
              ...
              <td class="style11" align="center">&nbsp;</td>
              <td class="style11"><input name="Submit" type="submit" class="subHeader" value="Capturar" onClick="return verificaNcol_pend(document.forms.form)" onChange="setSur(this.form)" /></td>
            </tr>
            <tr>
              <td class="style11">&nbsp;</td>
