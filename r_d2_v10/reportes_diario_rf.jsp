  ...
  <tr bgcolor="#D5EDB3">
    ...
    <td height="50" colspan="3" align="center" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" id="logo"><div align="right">
      <table width="946" border="0" align="left" cellpadding="2">
        <tr>
          <td width="870" rowspan="2"><div align="center" class="style5 style6">SISTEMA REPORTEADOR DE VENTA DIARIA RECETA POR FARMACIA </div></td>
          ...
          <tr>
            <td width="453" class="bodyText"><table width="917" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="867"><div align="center">
                      <table width="804" border="0" align="center" cellpadding="2" cellspacing="3">
                        <form action="val_diario.jsp" method="post" >
                          <tr>
                          ...
                          <tr>
                            <td colspan="14" class="style1"><div align="left"><a href="index_diario.jsp">Regresar a Men&uacute; </a></div></td>
                          </tr>
                          <tr>
                            <td colspan="14" class="style1">&nbsp;</td>
                          </tr>
                          <tr>
                            <td colspan="16" class="style1" ><div align="center">
                              <input name="reporte" type="radio" value="global"  checked="checked"/>
                           Reporte Diario de Ventas RF                            </div></td>
                          </tr>
                          <tr>
...
<%
        ...
        <label></label>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="submit" name="Submit" value="Por Fechas" class="style1"/></td>
                          </tr>
                          <tr>
                            ...
                            <td width="22" class="style1 style2">&nbsp;</td>
                            <td width="441" colspan="2"><div align="left"></div></td>
                          </tr>
                          <tr>
                  ...
                  <td width="13" nowrap bgcolor="#FFFFFF"><img src="imagenes/px.gif" width="1" height="1" alt="" border="0" /></td>
                </tr>
                <tr>
                  <td colspan="4">&nbsp;</td>
                </tr>
