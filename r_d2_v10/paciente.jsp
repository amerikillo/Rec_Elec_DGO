...
try { 
  ...
  Statement stmt = conn__001.createStatement();
	 ...
	 stmt.execute("insert into seguro_p2 values ('"+noaf_jv+"','"+ap_jv+"','"+am_jv+"','"+nom_jv+"','"+nombre1_jv+"','-','-','-','"+fechaini+"','"+fechafin+"','"+programa_jv+"','"+edad_jv+"','"+fechana+"','-',0)");
    ...
    <tr>
      <td width="731"><table width="650" height="478" border="0" align="center" cellpadding="2">
        ...
        <tr>
          ...
          <td><span class="style5">
            <label></label>
            </span><div align="left" class="Estilo1">EDAD:</div></td>
            
          <td><input name="txtf_edad" type="text" id="txtf_noaf"  onKeyPress="validar(event);"/></td>
            <strong></strong>
          <td>&nbsp;</td>
        </tr> 
        <tr>
