     ...
     String val="h";
         ...
         //variables para mostrar en campos
            ...
            String lote_jv= "";
				...
				//out.print(usuario);
                String cant2="",clave2="",descrip2="",lote2="",caducidad2="",origen2="",suma2="",suma21="",suma222="",sumanew="",clave22="",encontrado="",cantp="";
 ...
 */
 ...
 stmt_ruta.execute("update inventario_carga set clave='"+clave_str_1+"' where clave='"+clave_str+"';");
 //Actualizar clave-----------------------------------------------------------------------------------
...
stmt_6carga.execute("insert into modificacion values('"+clave2+"','"+descrip2+"','"+lote2+"','"+caducidad2+"',"+totalnew+",'"+origen2+"',"+total2+",'"+mtotal2+"','"+fecha_modi+"','"+usuario+"','INCREMENTO CARGA INVENTARIO','',current_timestamp,'-','-','-','-','-','-',0)");
                 ...
                 rset_4=stmt_4.executeQuery("select clave,descrip,lote,caducidad,sum(cant),origen from inventario_carga where clave='"+clave+"' and origen='"+origen+"' group by clave;");
                         ...
                         stmt_6.execute("insert into inventario_carga2 values ('"+clave2+"','"+descrip2+"','"+lote2+"','"+caducidad2+"','"+total2+"','"+origen2+"',0,1,'"+total2+"')");
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title>:: SISTEMA CARGA DE INVENTARIOS DGO ::</title>
            ...
            <tr bgcolor="#FFFFFF" >
                ...
                <td height="63" colspan="3" id="logo" valign="bottom" nowrap="nowrap"><div align="center" bgcolor="#FFFFFF" >
                        <div align="left">
                            ...
                            <span class="Estilo2">SISTEMA DE CARGA DE INVENTARIOS</span> &nbsp;&nbsp;
                            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="114" height="78">
                    ...
                    <form action="index_carga.jsp?cv_unidad=<%=clave_jv%>&usuario=<%=usuario%>" method="post" name="form" >
                        ...
                        <table width="764" border="1">
                            ...
                            <tr>
                                ...
                                <td><input type="file" name="exa" value="load"  onchange="examinar(this.value);"/>&nbsp;&nbsp;<input type="submit" name="Submit" value="Cargar" />
                                1</td>
                            </tr>
