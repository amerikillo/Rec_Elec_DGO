...
String date2_jv="",origen_jv="",origen2_jv="";
  try{
...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
 ...
 rset__001=stmt__001.executeQuery("select * from t_rep where execu='"+recibe_jv+"'  and date between '"+date1_jv+"' and '"+date2_jv+"' ");
	...
	{
 rset__001=stmt__001.executeQuery("select clave,descrip,sum(cant_sur),present from receta_colectiva where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' and partida='"+origen_jv+"' and tipo_receta='rc' group by clave order by clave asc; ");
	}
...
<table width="1320" cellpadding="3" cellspacing="1" border="0" >
  <tr height="20">
    ...
    <td width="27" height="20"  align="center">&nbsp;</td>
    <td width="87" height="20"  align="center">&nbsp;</td>
    <td width="90" height="20"  align="center"><img src="http://201.122.132.241:8080/cen_dgo/logo_dgo.jpg" width="96" height="88" /></td>
    <td height="20" colspan="3" align="center" >&nbsp;</td>
    <td width="421" height="20"  align="center">&nbsp;</td>
    <td  align="center">&nbsp;</td>
    <td  align="center">&nbsp;</td>
    <td  align="center">&nbsp;</td>
    <td height="20"  align="center"><img src="http://201.122.132.241:8080/cen_dgo/soriana.jpg" width="96" height="88" /></td>
    <td width="19" height="20"  align="center">&nbsp;</td>
    <td width="95" height="20"  align="center">&nbsp;</td>
  </tr>
  <tr height="20">
    <td height="20" colspan="14"  align="center"><p align="center">GOBIERNO DEL ESTADO DE DURANGO</p>
    ...
    <p align="center">PERIODO: <%=date1_jv%> al <%=date2_jv%></p>      
    <p align="center">ORIGEN &quot;<%=origen2_jv%>&quot;  </p>    </td>
  </tr>
  
  <tr height="20">
    <td height="20" colspan="2" style="border:double"><div align="center">CLAVE ARTICULO </div></td>
    <td height="20" colspan="6" style="border:double"><div align="center">DESCRIPCI&Oacute;N</div></td>
    ...
    <td colspan="2" style="border:double"><div align="center">PIEZAS PROXIMAS A COBRAR </div></td>
  </tr>
  <%
   present="1";
  ...
  <tr height="20" >
    <td colspan="2" align="left" style="border:double" ><%=rset__001.getString("clave")%></td>
    <td height="20" colspan="6" style="border:double"><div align="center"><%=rset__001.getString("descrip")%></div>      <div align="center"></div></td>
