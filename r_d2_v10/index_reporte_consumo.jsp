...
<table width="666" height="346" border="3" align="center" cellpadding="2" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="650"><form id="form" name="form" method="post" action="index_reporte_consumo.jsp">
      <table width="650" height="323" border="0" align="center" cellpadding="2">
        <tr>
          ...
          <td height="49" colspan="2" bgcolor="#FFFFFF" class="logo style1"><div align="center">Men&uacute; de Consumo Semanal </div></td>
        ...
        <tr>
          ...
          <td colspan="2" class="style5"><label><a href="dispensado.jsp">CONSUMO  SEMANAL RECETA POR FARMACIA</a></label></td>
          <td class="style5">&nbsp;</td>
        </tr>
        <tr>
          <td height="20"><div align="right">
          ...
          <td colspan="2" class="style5"><label><a href="dispensado_col.jsp">CONSUMO  SEMANAL RECETA COLECTIVA</a> </label></td>
          <td>&nbsp;</td>
        </tr>
