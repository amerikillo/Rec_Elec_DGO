...
if(but.equals("Clave"))
     {
	  ...
	  folio_jv=request.getParameter("txtf_foliosp");
		  ...
		  rset1= stmt.executeQuery("select clave from pasti_ampu where clave='"+med1_jv+"' ");
...
if(but.equals("Capturar"))
     {
	  ...
	  String  ampuleo= "-";
	  int     corte  = 0;
	  boolean banderaCorteFolio = false;
	  ...
	  mtotal=cant2_jv-sur2;
	   ...
	   //Si ampuleo = true entonces se insertara en el campo 7 un 1 indicando 	que es ampuleo
	   ...
	   stmt1.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_jv+"','"+part_jv+"','-"+sur1_jv+"','"+mtotal+"','"+fechanew+"','"+encar_jv+"','SALIDA VÍA RECETA','','"+reloj_jv+"','"+foliore_jv+"','-','-','-','-','-',0)");	   
	   }else{
	  ...
	  */
	  ...
	  //stmt.execute("insert into receta values ('"+foliore_jv+"','"+fechanew+"','"+reloj_jv+"','"+juris_jv+"','"+no_jur+"','"+nom_unidad+"','"+nombre_jv+"','"+edad_jv+"','"+folio_jv+"','"+programa_jv+"','-','"+cedu_jv+"','"+nomed_jv+"','"+cause_jv+"','"+clave1_jv+"','"+descrip1_jv+"','"+cant2_o1_jv+"','"+cant2_o1_jv+"','SI','"+encar_jv+"','"+clave_jv+"','"+id_med_jv+"','"+cv_dgo_jv+"','"+cv_uni_jv+"','"+cv_finan_jv+"','"+financiamiento1+"','"+layout+"','"+partida_o1_jv+"','"+present1_jv+"','0','SURTIDO COMPLETO','RF','-','-','-','-','"+carnet_jv+"','-','"+fechanew+"','A','-','-','-','-','-','-','-','"+corte+"','"+ampuleo+"',0)");	
		...
		stmt.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant2_o1_jv+"','"+partida_o1_jv+"','-"+cant2_o1_jv+"','0','"+fechanew+"','"+encar_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','-','-','-',0)");
	   ...
	   */
	   ...
	   //--------------------------------Origen 3------------------------------------------------------------------------
		  ...
		  stmt.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_03+"','"+partida_o3_jv+"','"+(-cant2_o3_jv)+"','"+(cant_03-cant2_o3_jv)+"','"+fechanew+"','"+encar_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','-','-','-',0)");
		  }
	   }
	   if (mtotalotsur>0){
		if (cant2_o2_jv>0){
			  ...
			  stmt.execute("insert into modificacion values ('"+clave1_jv+"','"+descrip1_jv+"','-','-','"+cant_02+"','"+partida_o2_jv+"','"+(-(cant_02-cant2_o2_jv))+"','"+((cant2_o2_jv))+"','"+fechanew+"','"+encar_jv+"','SALIDA VÍA RECETA','',current_timestamp,'"+foliore_jv+"','-','-','-','-','-',0)");
			  }
		}	
		//if (mtotalotsur>0){
		//if (cant2_o2_jv>0){
...
if(but.equals("Imprimir"))
     {
	  ...
	  %>
	  <script>
	  self.location='recibo_farm_fecha.jsp?folio=<%=foliore2_jv%>&receta5=RF&encar=<%=encar_jv%>&uni=<%=nom_unidad%>&juris=<%=no_jur%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&part=<%=part_jv%>&id_med=<%=id_med_jv%>&perfil=<%=perfil%>';
...
<form name="form" method="post" onsubmit="return checkSubmit();" action="recedgo_fecha.jsp?uni=<%=nom_unidad%>&juris=<%=no_jur%>&nombre=<%=nombre_jv%>&edad=<%=edad_jv%>&folio=<%=folio_jv%>&clave1=<%=clave1_jv%>&descrip1=<%=descrip1_jv%>&present1=<%=present1_jv%>&indica1=<%=indica1_jv%>&sol1=<%=sol1_jv%>&sur1=<%=sur1_jv%>&cause=<%=cause_jv%>&foliore=<%=foliore_jv%>&encar=<%=encar_jv%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&univer=<%=uni_jv%>&cedu=<%=cedu_jv%>&nomed=<%=nomed_jv%>&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&day5=<%=t1_jv%>&mes5=<%=t2_jv%>&aa5=<%=t3_jv%>&programa=<%=programa_jv%>&perfil=<%=perfil%>">
  ...
  <tr>
    <td width="956" height="114"><table width="837" border="0" align="center" cellpadding="2">
      ...
      <tr>
        ...
        <td width="225"><div align="right"><img src="logo_dgo.jpg" width="109" height="76" /></div>
      ...
      <table width="854" height="45" border="0" align="center" cellpadding="2">
        ...
        <tr>
          <td height="91" colspan="3" class="style4"><table width="852" border="0" align="center" cellpadding="2">
            <tr>
           ...
           %>
             ...
             <a href="renovacion.jsp" target="popup"
						...
						Renovación De Vigencia
                         ...
                         <!--td width="50">  <div align="center"><a href="renovacion.jsp" target="_blank" class="Estilo7">renovacion de vigencia</a ></div></td-->
              
            </tr>
            <tr>
              <td width="534" height="52" class="style2">NOMBRE DEL PACIENTE:
                <label> </label>
                <span class="style5">
                <label> </label>
                ...
                <input name="txtf_carnet" type="text" class="style13" value="<%=carnet_jv%>" size="5"  onKeyPress="return handleEnter(this, event)"/></span>
                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;APELLIDO PATERNO <span class="style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;APELLIDO MATERNO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NOMBRE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></label></td>
              <td width="139"><table width="137" border="0" align="right" cellpadding="2">
                <tr>
        ...
        <tr>
          <td height="38" colspan="3" class="style4"><table width="763" border="0" align="center" cellpadding="2">
            <tr>
              ...
              NOMBRE:
              <input name="txtf_nomed" id="txtf_nomed" type="text" class="style13" value="<%=nomed_jv%>" size="35"  onKeyPress="return handleEnter(this, event)" />
        ...
        <tr>
          <td height="219" colspan="3" class="style4"><table width="875" border="0" align="center" cellpadding="2">
            
            <tr>
              <td colspan="3" class="style11">Ingrese Clave:
              <input type="text" name="txtf_med1" id="txtf_med1" size="10" value="<%=med1_jv%>"  onkeypress="return handleEnter(this, event)"/><input name="Submit" type="submit" class="subHeader" value="Clave" onClick="habilitaBoton();" />&nbsp;<a href="index_carga_clave.jsp" target="_blank">Agregar Clave al Inventario</a></td>
               <td colspan="3" class="style11"><span class="style2"><span class="Estilo8">TOTAL EXISTENCIAS:</span><span class="Estilo5"> <%=sumatotal%>&nbsp;</span></span></td>
              <td width="276" class="style11"><label>
                <div align="center">
            ...
            <tr>
              ...
              <td width="74" class="style11"><span class="style2">CANT. SOL</span></td>
            ...
            <tr>
              ...
              <input name="Submit" type="submit" id="capturaid" class="but" value="Capturar" onClick="return verificaN_Fa(document.forms.form);" onChange="setSur(this.form)" />
             	 <%
		   		if(!perfil.equals("") && perfil.equals("ADMON")){
				
			    %>
				
					<input name="Submit" type="submit" name="corte" id="corteid" class="but" onclick="bloquea(this.form)" value="Corte" />
            ...
            <tr>
              ...
              <td width="40" align="center" class="style11"><span class="style2">CANT. SUR </span></td>
              <td width="89" align="center" class="style11"><span class="style2">SE SURTI&Oacute;</span></td>
