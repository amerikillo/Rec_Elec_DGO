...
<table width="384" height="490"  border="3" align="left" cellpadding="2">
  <tr>
    <td width="372" height="92"><table width="370" border="0" cellpadding="2">
      <tr>
        <td width="362" class="style7"><div align="center"><strong><span class="style5"><a href="recedgo_fecha.jsp?encar=<%=encar_jv%>&uni=<%=nom_unidad%>&juris=<%=no_jur%>&juris1=<%=juris_jv%>&clave_uni=<%=clave_jv%>&nombre=&edad=&folio=&clave1=&descrip1=&present1=&indica1=&sol1=&sur1=&clave2=&descrip2=&present2=&indica2=&sol2=&sur2=&clave3=&descrip3=&present3=&indica3=&sol3=&sur3=&foliore=&univer=&cedu=&nomed=&cv_dgo=<%=cv_dgo_jv%>&cv_uni=<%=cv_uni_jv%>&cv_mpio=<%=cv_mpio_jv%>&id_med=<%=id_med_jv%>&cause=SC&part=&day5=&carnet=-&mes5=&aa5=&perfil=<%=perfil%>">*</a>TIENDAS SORIANA  S.A DE C.V.* </span></strong></div></td>
      </tr>
      <tr>
  ...
  <tr>
   ...
   while(rset1.next()) 
      ...
      <tr>
		...
		<% if (rset1.getString("ampuleo").equals("1")){%> 
			<td class="style8" align="center">Amp</td>
		<%}else{%>
  ...
  <tr>
   ...
   while(rset3.next()) 
      ...
      <td class="style8" align="center">Consecutivo: <%=rset3.getString("corte")%></td>
