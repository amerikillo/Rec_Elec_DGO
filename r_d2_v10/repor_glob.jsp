...
response.setHeader("Content-Disposition","attachment; filename=REPORTE GLOBAL.xls");
%>
<head>
...
rset_001 = stmt_001.executeQuery("SELECT STR_TO_DATE('"+date2_jv+"', '%d/%m/%Y')"); 
 ...
 rset__001=stmt__001.executeQuery("select * from t_rep where execu='"+recibe_jv+"'  and date between '"+date1_jv+"' and '"+date2_jv+"' ");
	...
	{
 rset__001=stmt__001.executeQuery("select clave,descrip,sum(cant_sol),sum(cant_sur) from receta where unidad='"+llamo_cat_jv+"' and fecha_re between '"+date1_jv+"' and '"+date2_jv+"' group by clave");
	}
...
<table width="710" cellpadding="3" cellspacing="1" border="0" >
  <tr height="20">
    <td height="20"  align="center"><img src="http://201.122.132.241:8080/r_d_2/logo_dgo1.jpg" width="96" height="88" /></td>
    <td height="20" colspan="3" align="center" >&nbsp;</td>
    <td height="20"  align="center"><img src="http://201.122.132.241:8080/r_d_2/soriana.jpg" width="96" height="88" /></td>
  </tr>
  
  <tr height="20">
    
    <td height="20" colspan="5"  align="center">
	<p align="center">GOBIERNO DEL ESTADO DE DURANGO</p>
	<p align="center">SECRETARIA DE SALUD</p>
	<p align="center">TIENDAS SORIANA  S.A DE C.V.</p>
	<p align="center">REPORTE GLOBAL DE CONSUMO </p>
  ...
  <tr height="20">
    ...
    <td height="20" style="border:double">&nbsp;</td>
    <td height="20" style="border:double">&nbsp;</td>
    <td height="20" style="border:double">&nbsp;</td>
    <td height="20" style="border:double">&nbsp;</td>
    <td height="20" style="border:double">&nbsp;</td>
  ...
  <tr height="20">
    ...
    <td width="92" style="border:double"><div align="center">Clave Articulo </div></td>
    <td width="239" style="border:double"><div align="center">Descripci&oacute;n</div></td>
    <td width="88" style="border:double"><div align="center">Costo</div></td>
    <td width="109" style="border:double"><div align="center">Cant. Sol </div></td>
    <td width="146" style="border:double"><div align="center">Cant. Sur</div></td>
  </tr>
  <%
  ...
  <tr height="20" >
    ...
    <td style="border:double"><%=sol11%></td>
    <td style="border:double"><%=sur11%></td>
  </tr>
  <%
  }
