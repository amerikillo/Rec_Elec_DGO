        ...
        <td width="418"><table width="1500" border="1">
            <tr>
			  ...
			  <td width="58"> <span class="Estilo8">Presentaci&oacuten</span></td>
			   <td width="58"> <span class="Estilo8">Caja Ampuleo</span></td>
	...
	%>
            <tr>
			  ...
			  <td align="center"><span class="Estilo8"><%=presentacion%></span></td>
			   <td align="center"><span class="Estilo8"><%=presentaInfo%></span></td>
            ...
            <tr>
              ...
              <td class="Estilo5" align="center"><%=sur1%></td>
			   <td width="58"> <span class="Estilo8"></span></td>
			  <td width="58"> <span class="Estilo8"></span></td>
			   <td class="Estilo5"  align="center"> <%=totalCajasAmpuleo%></td>
