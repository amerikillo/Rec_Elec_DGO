      ...
      <tr>
        <td width="418"><table width="1000" border="1">
            <tr>
			  ...
			  <td width="103"> <span class="Estilo13">Ampula</span></td>
			   <td width="103"> <span class="Estilo13">Presentaci&oacute;n</span></td>
			   <td width="103"> <span class="Estilo13">Cajas ampuleo</span></td>
	...
	%>
            <tr>
			  ...
			  <td align="center"><span class="Estilo9"><%=presentacion%></span></td>
     		  <td align="center"><span class="Estilo9"><%=presentaInfo%></span></td>
            </tr>
			<%}
            ...
            <tr>
              ...
              <td align="center" class="Estilo9"><%=sur1%>&nbsp;</td>
			  	    <td width="103"> <span class="Estilo13"></span></td>
				 <td width="103"> <span class="Estilo13"></span></td>
				 <td width="103" align="center"> <span class="Estilo13"><%=totalCajasAmpuleo%></span></td>
